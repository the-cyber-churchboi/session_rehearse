...
<body>
    <header>
        <div class="header-container">
            ...
            <div class="icon-container">
                <div class="chat-button">
                    <a href="developer_chat.php"><i class="fas fa-comment-alt" style="color:#835237; font-size:40px;"></i></a>
                </div>
        ...
        <nav class="navbar-expanded" id="navbar">
            <ul>
                <li><a href="developer_profile.php" class="navbar-icon" style="color: red;"><i class="fas fa-user" style="color: black"></i>Profile</a></li>
    ...
    <main>
        <?php
            ...
            if ($incompleteProfile) {
                echo "<div class='profile-incomplete-message'>Your profile is incomplete. <a href='developer_complete_profile.php'>Complete Profile</a></div>";
            }
        ?>
    ...
    <script>
        ...
        function displayImageDetails(image) {
            ...
            secondCompartment.innerHTML = `
                <div class="displayed-image-container">
                    ...
                    <a href="fetch_feedback.php?property_id=${propertyId}" class="feedback-link">Check Feedback</a>
        ...
        function populateMyBuildings() {
            ...
            const url = 'fetch_developer_my_buildings.php';
        ...
        function openBuildingModal(buildingElement, buildingId) {
            ...
            window.location.href = 'fetch_feedback.php?property_id=' + buildingId;
        }
