...
try {
    ...
    $buildingNamesQuery = "SELECT property_name FROM property_registration WHERE user_id = :managerUserId";
...
<body>
    <header>
        <div class="header-container">
            ...
            <a href="developer_dashboard.php"><i class="fas fa-arrow-left"></i> Back to Dashboard</a>
        </div>
    </header>
    ...
    <div class="split-interface">
        ...
        <div class="admin-list">
            <h2 class="admin-list-header">Professionals</h2>
    ...
    <script>
        ...
        function openChatWithUser(userUsername, userUniqueIdentifier) {
            ...
            // Remove the badge by clearing its content and hiding it
            const badgeElement = document.getElementById('unreadCount_' + userUniqueIdentifier);
            badgeElement.textContent = ''; // Clear the badge content
            badgeElement.style.display = 'none'; // Hide the badge
        }
