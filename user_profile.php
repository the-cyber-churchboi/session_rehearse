...
function isUsernameUnique($pdo, $newUsername, $currentUsername) {
    $stmt = $pdo->prepare("SELECT COUNT(*) FROM users WHERE username = :newUsername AND username != :currentUsername");
...
$user_id = $_SESSION['user_unique_id']; // Replace with your authentication logic
$sql = "SELECT * FROM users WHERE unique_identifier = :user_id";
...
if (isset($_POST['update_profile'])) {
    ...
    if (empty($updateProfileErrors)) {
        ...
        $stmt = $pdo->prepare("SELECT password FROM users WHERE unique_identifier = :user_id");
        ...
        if ($row) {
            ...
            if (password_verify($current_password, $hashed_password)) {
                ...
                if (validatePassword($new_password)) {
                    ...
                    $stmt = $pdo->prepare("UPDATE users SET password = :new_password WHERE unique_identifier = :user_id");
