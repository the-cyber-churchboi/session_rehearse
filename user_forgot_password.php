...
<body>
    ...
    <script>
        ...
        function checkEmailExists(email) {
            const url = 'user_check_email.php'; // Replace with the actual path to your PHP script
        ...
        function sendResetToken(email) {
            const url = 'user_send_reset_token.php'; // Replace with the actual path to your PHP script
