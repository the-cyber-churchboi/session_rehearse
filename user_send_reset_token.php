...
function generateResetToken($email) {
    ...
    $sql = "UPDATE users SET reset_token = :token, token_expiration = :expiration WHERE email = :email";
...
function sendPasswordResetLink($email, $resetToken) {
    ...
    . '<a href="http://localhost/building_work/user_reset_password.php?token=' . urlencode($resetToken) . '">Reset Password</a>';
